...
//                 <motion.button
//                   onClick={() => setPage((prev) => prev + 1)}
//                   className="flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-orange-500 to-pink-600 text-white font-bold rounded-2xl shadow-lg hover:shadow-xl transition-all"
//                   whileHover={{ scale: 1.05 }}
//                   whileTap={{ scale: 0.95 }}
//                 >
//                   <FaChevronDown /> Load More Restaurants
//                 </motion.button>
//               </motion.div>
//             )}
//           </>
...
//     whileHover={{ y: -3 }}
//   >
//     <div className="absolute inset-0 bg-gradient-to-br from-orange-500/20 to-pink-500/20 rounded-2xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity"></div>
...
//     >
//       {/* Header with Logo */}
//       <div className="relative h-32 bg-gradient-to-br from-orange-400 via-rose-400 to-purple-500 p-4">
//         {/* Pattern */}
//         <div
//           className="absolute inset-0 opacity-20"
//           style={{
...
//             </div>
//           )}
//           <div className="flex items-center gap-1 px-2 py-1 rounded-lg bg-gray-100 dark:bg-slate-800">
...
//                 onClick={onApprove}
//                 disabled={isLoading}
//                 className="flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-400 font-semibold text-sm hover:bg-emerald-200 dark:hover:bg-emerald-900/50 transition-all disabled:opacity-50"
//                 whileHover={{ scale: 1.02 }}
//                 whileTap={{ scale: 0.98 }}
//               >
//                 {isLoading ? (
...
//                 onClick={onReject}
//                 disabled={isLoading}
//                 className="flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-400 font-semibold text-sm hover:bg-red-200 dark:hover:bg-red-900/50 transition-all disabled:opacity-50"
//                 whileHover={{ scale: 1.02 }}
//                 whileTap={{ scale: 0.98 }}
//               >
//                 <FaTimes />
...
//       >
//         {/* Header */}
//         <div className="relative h-40 bg-gradient-to-br from-orange-500 via-rose-500 to-purple-600">
//           <div
//             className="absolute inset-0 opacity-20"
//             style={{
//               backgroundImage: `url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%23ffffff' fill-opacity='0.4'%3E%3Cpath d='M36 34v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm0-30V0h-2v4h-4v2h4v4h2V6h4V4h-4zM6 34v-4H4v4H0v2h4v4h2v-4h4v-2H6zM6 4V0H4v4H0v2h4v4h2V6h4V4H6z'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E")`,

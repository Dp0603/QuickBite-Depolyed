...
//           <FaRegStar key={`empty-${i}`} className="text-gray-300 dark:text-gray-600" />
//         ))}
//       </div>
//       {showNumber && (
...
//     return { total, approved, flagged, pending, avgRating, fiveStars, lowRatings };
//   }, [reviews]);
...
//             onApprove={(r) =>
//               setConfirmAction({ type: "approve", review: r })
//             }
...
//             </div>
//             <span className="text-white/90 font-semibold">Review Moderation</span>
//           </div>
...
//                 {[...Array(5)].map((_, i) => (
//                   <FaStar key={i} className={`text-xs ${i < Math.floor(avgRating) ? '' : 'opacity-30'}`} />
//                 ))}
//               </div>
//             </div>
//           </div>
...
//       >
//         {/* Header */}
//         <div className={`relative h-36 bg-gradient-to-br ${config.gradient} to-slate-800`}>
//           <div
...
//                 <span className="text-3xl font-black text-white">{review.rating}</span>
//               </div>
//               <div>
...
//                     <FaStar
//                       key={i}
//                       className={i < review.rating ? "text-white" : "text-white/30"}
//                     />
//                   ))}
//                 </div>
...
//                 {review.rating >= 4 ? "85%" : review.rating >= 3 ? "50%" : "20%"}
//               </p>
//             </div>
...
//                 {review.rating >= 4 ? "15%" : review.rating >= 3 ? "50%" : "80%"}
//               </p>
//             </div>
//           </div>
...
// /* Confirm Action Modal */
// const ConfirmActionModal = ({ type, review, onConfirm, onClose, isProcessing }) => {
//   const config = {
//     approve: {
...
//                 <p className="text-white/80 text-sm">Review by {review.userId?.name}</p>
//               </div>
//             </div>
//             <motion.button
//               onClick={onClose}
...
//             >
//               <span className={`text-4xl ${current.textColor}`}>{current.icon}</span>
//             </div>
...
//                   Warning: This action is irreversible. The review and all associated data will be permanently deleted.
//                 </p>
//               </div>
//             </div>
//           )}

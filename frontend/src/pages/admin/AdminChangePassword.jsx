...
const TipItem = ({ icon, text, color }) => {
  ...
  return (
    <div className="flex items-start gap-3">
      <div
        className={`w-8 h-8 rounded-lg ${colors[color]} flex items-center justify-center flex-shrink-0`}
      >
        {icon}
      </div>
  ...
  >
    <div
      className={`w-5 h-5 rounded-full flex items-center justify-center ${
        passed ? "bg-emerald-500 text-white" : "bg-gray-200 dark:bg-slate-700"
      }`}
    >

...
export const restaurantRoutes = (isOwnerMode) => [
  ...
  // Menu Management
  <Route
    key="restaurant-menu-manager" path="menu-manager" element={<RestaurantMenuManager />}
  />,
  <Route
    key="restaurant-menu-scheduler" path="menu-scheduler" element={<RestaurantMenuScheduler />}
  />,
  <Route key="restaurant-add-menu" path="menu/add" element={<RestaurantAddDish />} />,
  <Route
    key="restaurant-edit-menu" path="menu/edit/:id" element={<RestaurantEditDish />}
  />,
  <Route
    key="restaurant-availability-toggle" path="availability-toggle" element={<RestaurantAvailabilityToggle />}
  />,
  ...
  // Delivery
  <Route key="restaurant-delivery" path="delivery-status" element={<RestaurantDeliveryStatus />} />,

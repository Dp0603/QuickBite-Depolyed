...
export default function Navbar() {
  ...
  // Treat partner page as a public page so navbar shows there as well
  const isPublicPage = ["/", "/login", "/register", "/partner"].includes(
    location.pathname
  );
  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-50 backdrop-blur-[2px] bg-white/15 dark:bg-black/15 shadow-sm px-6 sm:px-8 py-4 flex justify-between items-center">
      ...
      <div className="flex flex-wrap gap-3 items-center">
        {/* Partner Link - show on public pages but not when already on /partner */}
        {isPublicPage && location.pathname !== "/partner" && (
          <Link
            to="/partner"
        ...
        {/* On partner page allow easy navigation away */}
